...
#define PLATFORM_SERIAL     SerialUSB
...
#define X_STEPS_PER_UNIT    200
#define Y_STEPS_PER_UNIT    200
#define X_MM_PER_STEP       (1/X_STEPS_PER_UNIT)
#define Y_MM_PER_STEP       (1/Y_STEPS_PER_UNIT)

// X, Y, Z, E steps per unit - Metric Prusa Mendel with Wade extruder:
#define _AXIS_STEP_PER_UNIT {X_STEPS_PER_UNIT, Y_STEPS_PER_UNIT, 3200/1.25,700}
